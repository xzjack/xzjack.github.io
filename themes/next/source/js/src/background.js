    ...
    var Confetti = function () {
        function Confetti(param) {
            ...
            this.canvas.style.cssText = ["display: block", "position: absolute", "top: 0", "left: 0", "opacity: 0.3", "pointer-events: none"].join(";");
    ...
    (function () {
        var DURATION = 12000*(document.documentElement.scrollHeight/window.innerHeight),
            LENGTH = 24*(document.documentElement.scrollHeight/window.innerHeight);
